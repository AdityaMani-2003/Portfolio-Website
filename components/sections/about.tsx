                        ...
                        <div className="space-y-12">
                            ...
                            <BlurReveal>
                                <h3 className="text-3xl md:text-5xl lg:text-6xl font-light leading-[1.1]">
                                    A developer who grows through{" "}
                                    <span className="font-serif italic">self-driven projects</span>{" "}
                                    and turns ideas into{" "}
                                    <span className="font-bold">real products</span>.
                                </h3>
                            </BlurReveal>

                            <BlurReveal>
                                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl">
                                    A <em>web development-focused</em> mindset; building on both frontend and
                                    backend, learning new technologies through{" "}
                                    <strong>hands-on experimentation</strong>,
                                    and prioritizing <strong>maintainable code</strong>.
                                    <br /><br />
