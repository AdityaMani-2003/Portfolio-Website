            ...
            >
                ...
                <div className="flex justify-between items-start w-full">
                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <span className="text-[10px] font-mono tracking-[0.3em] uppercase text-foreground/60 [writing-mode:vertical-lr]">
                            SCROLL
                        </span>
                    </div>
                </div>

                <div className="w-full mt-auto flex flex-col justify-center relative z-30 drop-shadow-sm">
                    <div className="overflow-visible pr-[20vw] sm:pr-0">
                        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-[80px] xl:text-[96px] 2xl:text-[110px] font-black tracking-tighter leading-[0.85] text-foreground uppercase whitespace-nowrap">
                ...
                <div className="space-y-6 sm:space-y-10 relative z-30">
